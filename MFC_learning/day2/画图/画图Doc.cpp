...
// 缩略图的支持
void C画图Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void C画图Doc::InitializeSearchContent()
{
...
void C画图Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
